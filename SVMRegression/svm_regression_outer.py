...
from svm_regression_model import svm_regression
...
def svm_regression_outer(json_input_file = {} #json input path
                            ):
    ...
    try:
        ...
        #model info jsom
        model_info = {}
        model_info['Algorithm_Name'] = 'SVM Regression'
        ...
        output_json['Algorithm_Name'] = 'SVM Regression'
