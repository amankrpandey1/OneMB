...
from svm_classifier_model import svm_classifier
...
def svm_classifier_outer(json_input_file = {} #json input path
                            ):
    ...
    try:
        ...
        #model info jsom
        model_info = {}
        model_info['Algorithm_Name'] = 'SVM Classification'
        ...
        output_json['Algorithm_Name'] = 'SVM Classification'
