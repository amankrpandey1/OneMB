...
from logistic_classifier_model import logistic_classifier
...
def logistic_classifier_outer(json_input_file = {} #json input path
                            ):
    ...
    try:
        ...
        output = logistic_classifier(data,
                                num_cols,
                                cat_cols,
                                target)
        ...
        #model info jsom
        model_info = {}
        model_info['Algorithm_Name'] = 'Logistic Regression'
        ...
        output_json['Algorithm_Name'] = 'Logistic Regression'
