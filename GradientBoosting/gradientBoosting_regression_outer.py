...
from gradientBoosting_regression_model import gradientBoosting_regression
...
def gradientBoosting_regression_outer(json_input_file = {} #json input path
                            ):
    ...
    try:
        ...
        output = gradientBoosting_regression(data,
                                           num_cols,
                                           cat_cols,
                                           target)
        ...
        #model info jsom
        model_info = {}
        model_info['Algorithm_Name'] = 'Gradient Boosting Regression'
        ...
        output_json['Algorithm_Name'] = 'Gradient Boosting Regression'
